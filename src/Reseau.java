...
public class Reseau {
    ...
    public Reseau(InstanceSegmentationGraphe ins) {
        //A COMPLETER
        // Initialisation de this.s et this.t
        this.s = ins.getN();
        this.t = ins.getN() + 1;

        // Créer un graphe de taille n+2 avec les même arcs existants dans ins.getGraphe()
        this.g = new Graphe(ins.getN() + 2, ins.getGraphe());


        // Set les arcs des sommets s et t du graphe
        this.g.setAuxS_T(ins.getB(), ins.getF());
    ...
    public Couple<Flot, ArrayList<Integer>> flotMaxCoupeMin() {
        Flot f = new Flot(this);
        System.out.println(this.trouverCheminDansResiduel(f));
