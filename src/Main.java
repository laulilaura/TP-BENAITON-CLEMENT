...
public class Main {
	...
	//A COMPLETER
		...
		Img img = new Img(instance);
		//img.creerImage("img1.pgm");
	return img;
	...
	//A COMPLETER
		ArrayList<Couple<Integer, Integer>> AC1 = new ArrayList<Couple<Integer, Integer>>();
		Couple<Integer, Integer> c1= new Couple<Integer, Integer>(2,0);
		AC1.add(c1);

		ArrayList<Couple<Integer, Integer>> AC2 = new ArrayList<Couple<Integer, Integer>>();
		Couple<Integer, Integer> c2 = new Couple<Integer, Integer>(0,0);
		AC2.add(c2);

		InstanceSegmentation imgInstanceSegmentation = new InstanceSegmentation(creerImgLigne(), AC1, AC2);
		return imgInstanceSegmentation;
