...
public class Graphe{
    ...
    public void setAuxS_T(ArrayList<Integer> b, ArrayList<Integer> f) {

        for (int i : b) {
            this.pred.get(i).add(new Couple<Integer, Integer>(this.getN()-2, Integer.MAX_VALUE));
            this.l.get(this.getN()-2).add(new Couple<Integer, Integer>(i, Integer.MAX_VALUE));
        }

        for (int i : f) {
            this.pred.get(this.getN()-1).add(new Couple<Integer, Integer>(i, Integer.MAX_VALUE));
            this.l.get(i).add(new Couple<Integer, Integer>(this.getN()-1, Integer.MAX_VALUE));
        }
    }
